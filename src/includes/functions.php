...
<body>
	 ...
	 */
	function addError($errortext, $die = false) {
	 ...
	 */
	function addMessage($messagetext, $die = false) {
...
class sql {
	...
	/**
	 * Executes a query on the database for inserting
	 *
	 * @param string $query Query to execute
	 * @return int ID generated by the insert, or false, if the query fails
	 */
